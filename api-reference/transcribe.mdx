...
<ParamField body="additionalVocabulary" type="string[]">
  An optional list of custom words or phrases to help the model better recognize and transcribe domain-specific or uncommon terms. Only available for `enhanced` models.
</ParamField>
...
```jsx Configuration example
{
  ...
  additionalVocabulary: ["flu", "COVID"],
  commands: [
    {
      id: "next_section",
