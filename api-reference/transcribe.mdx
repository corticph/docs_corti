---
title: Stateless front-end dictation 
...
<Info>
  ...
  - If you are looking for asynchronous transcript generation as part of an interaction, then please refer to the [/transcipts endpoint](/api-reference/transcripts)
</Info>
