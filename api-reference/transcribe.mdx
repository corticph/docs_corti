...
description: WebSocket Secure (WSS) API Documentation for /transcribe endpoint 
tag: WSS
---
...
<Info>
  ...
  - If you are looking for asynchronous transcript generation as part of an interaction, then please refer to the [/transcripts endpoint](/api-reference/transcripts/create-transcript/)
</Info>
