---
title: Real-time transcript and Fact generation 
...
<Info>
  ...
  - If you are looking for a stateless, atomic endpoint that is more geared towards front-end dictation workflows you should use the [/transcribe WSS](/api-reference/transcribe/)
  - If you are looking for asynchronous ambient documentation interactions, then please refer to the [/documents endpoint](/api-reference/documents)  
</Info>
