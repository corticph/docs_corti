...
<Accordion title="Code sample:">
    ...
    <Warning>This authentication method is not recommended, but sometimes necessary.</Warning>
...
- Breaks downstream audit trails, logging, and personalization.
    ...
    <Warning>Not appropriate for user-facing integrations or embedding Corti Assistant.</Warning>
