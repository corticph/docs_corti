...
- See the [dictation SDK](/sdk/dictation-sdk/) page for a packaged SDK ready to integrate into your app within minutes. 
</Accordion>
...
For more information on how to find and use existing templates, how to build templates dynamically in the document generation request, or how to request a custom template, please see more details in the [Templates & Documents](/templates/templates/) page. 
</Accordion>
