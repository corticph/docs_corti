...
The available API endpoints leverage the foundational models offered by Corti for conversational speech-to-text, font-end dictation, live Fact generation, document generation, code prediction, contextual chat, knowledge retrieval from authoritative public references or your custom sources, and more. This page will provide an overview of each endpoint listed in the API Reference. 
...
<br/>
<Check>
    To learn more, see the detailed pages under [Get Started](/get_started/getaccess/) or the comprehensive [API reference](/api-reference/) documentation. 
