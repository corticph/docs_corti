...
<Tip>Corti AI is the only platform supporting an Ambient Documentation LIVE workflow, where **real-time** `Fact` generation occurs _during_ audio recording. Turbo charge your ambient scribe solution by using the `Stream` endpoint.</Tip> 
