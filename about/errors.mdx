...
[docs-auth]: https://docs.corti.ai/get_started/quickstart
...
You're currently in limited access mode. To unlock full API functionality, 
please upgrade your plan by contacting support at [support][support].